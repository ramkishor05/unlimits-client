...
public class EOClientCommitmentItem extends EOCustObject {
	/**
	 * 
	 */
	...
	@ManyToOne
	private EOClientCommitmentGroup group;
	...
	public EOClientCommitmentGroup getGroup() {
		return group;
	}

	public void setGroup(EOClientCommitmentGroup group) {
		this.group = group;
	}
