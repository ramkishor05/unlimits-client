...
public class EOClientAffirmationItem extends EOCustObject {
	...
	@ManyToOne
	private EOClientAffirmationGroup group;

	public EOClientAffirmationGroup getGroup() {
		return group;
	}

	public void setGroup(EOClientAffirmationGroup group) {
		this.group = group;
	}
