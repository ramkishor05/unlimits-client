...
import com.brijframework.client.device.service.DeviceUnlimitsExampleService;
 ...
 */
@RestController
@RequestMapping({"/api/device/unlimits/example"})
@CrossOrigin("*")
public class DeviceUnlimitsExampleController implements CrudController<UIDeviceUnlimitsExample, EOUnlimitsExample, Long>{
	
	@Autowired
	private DeviceUnlimitsExampleService clientUnlimitsExampleService;

	@Override
	public CrudService<UIDeviceUnlimitsExample, EOUnlimitsExample, Long> getService() {
