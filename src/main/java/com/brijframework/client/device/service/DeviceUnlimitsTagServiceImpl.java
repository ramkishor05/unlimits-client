...
public class DeviceUnlimitsTagServiceImpl extends CrudServiceImpl<UIDeviceUnlimitsTag, EOUnlimitsTag, Long>
	...
	@Override
	public void merge(UIDeviceUnlimitsTag dtoObject, EOUnlimitsTag entityObject,
			UIDeviceUnlimitsTag updateDtoObject, EOUnlimitsTag updateEntityObject,
	...
	@Override
	public Page<EOUnlimitsTag> repositoryFindAll(Map<String, List<String>> headers, Pageable pageable, Map<String, Object> filters) {
		EOCustBusinessApp eoCustBusinessApp = (EOCustBusinessApp) ApiSecurityContext.getContext().getCurrentAccount();
		if (eoCustBusinessApp == null) {
			throw new UserNotFoundException("Invalid client");
		}
	...
	@Override
	public List<EOUnlimitsTag> repositoryFindAll(Map<String, List<String>> headers, Sort sort, Map<String, Object> filters) {
		EOCustBusinessApp eoCustBusinessApp = (EOCustBusinessApp) ApiSecurityContext.getContext().getCurrentAccount();
		if (eoCustBusinessApp == null) {
			throw new UserNotFoundException("Invalid client");
		}
