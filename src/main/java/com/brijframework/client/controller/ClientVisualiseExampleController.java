...
import com.brijframework.client.service.ClientVisualiseExampleService;
...
public class ClientVisualiseExampleController extends CrudController<UIClientVisualiseExample, EOClientVisualiseExample, Long>{
	...
	@Autowired
	private ClientVisualiseExampleService clientVisualiseExampleService;

	@Override
	public CrudService<UIClientVisualiseExample, EOClientVisualiseExample, Long> getService() {
		return clientVisualiseExampleService;
	}
	...
	public Response getCuurent(@RequestHeader(required =false)  MultiValueMap<String,String> headers){
		...
		try {
			response.setData(clientVisualiseExampleService.getCurrent(headers));
