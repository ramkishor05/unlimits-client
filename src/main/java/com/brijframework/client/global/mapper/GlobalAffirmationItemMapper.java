...
import com.brijframework.client.global.model.UIGlobalAffirmationItem;

@Mapper(componentModel = SPRING, implementationPackage = APP_CLIENT_PACKAGE_IMPL, unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface GlobalAffirmationItemMapper extends GenericMapper<EOAffirmationItem, UIGlobalAffirmationItem>{
